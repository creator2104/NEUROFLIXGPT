...
export const { addNowPlayingMovies , addTrailerVideo , addPopularMovies , addTrendingMovies , addHorrorMovies , addUpcomingMovies , addSciFiVideo , addThrillerMovies} = movieSlice.actions;
